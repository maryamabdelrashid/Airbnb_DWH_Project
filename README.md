...
This project demonstrates an end-to-end Data Warehouse solution using the Medallion Architecture (Bronze → Silver → Gold) on the Airbnb Prices in European Cities dataset.
...
- Built a relational model based on the Star Schema.
- Created KPIs, measures, slicers, and interactive visualizations.
